...
点光源是一种理想化的光源模型，它假设光源是一个没有大小和形状的点，能够向所有方向均匀地发射光线。这里构造了一个发光的小球来近似点光源。

构造过程类似面光源，在 `hittable_list` 中加入一个球面，并绑定散射光材质，球面的大小与光强呈正相关。
...
周桐欣：完成了点光源的增加，对光源进行了一定优化，减少了渲染结果中的噪声。
